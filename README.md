...
| [`@bacnh85/pi-attachments`](./pi-attachments) | 0.2.2 | Image and file attachments — drops/pastes become `[[attach:name]]` chips resolving to readable `📎` path references (images attach as real parts; text read on demand). |
