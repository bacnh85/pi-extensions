...
| [`@bacnh85/pi-cron`](./pi-cron) | 0.3.1 | Scheduled jobs — cron-style jobs fire a prompt into the live session while pi is running, with past-due catch-up, per-job model/thinking pins (headless runs), and crontab export for 24/7 coverage. |
