...
| [`@bacnh85/pi-subagent`](./pi-subagent) | 0.20.1 | Isolated in-process subagents with parallel/chain modes, inspectable threads, git worktree isolation (`sandbox: worktree`), and opt-in auto-review after coding turns. |
